  ...
  return (
    <header>
      <div className='header-left-div'>
        <div className='header-left-div-image-div'>
          <img src="/jioSaavanWrrittenLogo.png" alt="" />
        </div>
        <div className='header-right-ul-div'>
          <ul >
            <li>Music</li>
            <li>Podcast</li>
            <li>Pro</li>
      ...
      <div className='header-middle-div'>
        <input type="search"  placeholder='Search' className='global-search-input'/>
      </div>
